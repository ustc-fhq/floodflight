...
public class OFError extends OFMessage implements OFMessageFactoryAware {
    ...
    public enum OFSoftwareErrorCode {
        ...
        OFPSEC_FLOW_FIELD_NUMBER_EXCEED_LIMITATION(0x600C),
        OFPSEC_FLOW_INSTRUCTION_NUMBER_EXCEED_LIMITATION(0x600D),
        OFPSEC_FLOW_ACTION_NUMBER_EXCEED_LIMITATION(0x600E),
        OFPSEC_UNSUPPORT_CALCULATION_TYPE(0x600F),
        OFPSEC_DUPLICATE_TABLE_ID(0x6010),
        OFPSEC_CREATE_TABLE_FAILURE(0x6011),
        OFPSEC_DUPLICATE_ENTRY_ID(0x6012),
        OFPSEC_CREATE_ENTRY_FAILURE(0x6013),
        OFPSEC_INVALID_FIELD_LENGTH(0x6014),
        OFPSEC_INVALID_FIELD_OFFSET(0x6015),
        OFPSEC_UNSUPPORT_LPU_BOARD_TYPE(0x6016),
    ...
    public void setOffendingMsg(OFMessage offendingMsg) {
        if (offendingMsg == null) {
            ...
            super.setLengthU(minimumLength + offendingMsg.getLengthU());
        }
    }
