...
public enum OFInstructionType {
    ...
    GET_METADATA(37, OFInstructionGetMetadate.class, new OFInstructionGetMetadataInstantiable()),
    BRANCH(38, OFInstructionBranch.class, new OFInstructionBranchInstantiable()),
    RELATIVE_JUMP(39, OFInstructionRelativeJump.class, new OFInstructionJumpInstantiable()),
    CONDITIONAL_RELATIVE_JUMP(40, OFInstructionConditionalRelativeJump.class, new OFInstructionConditionalRelativeJumpInstantiable()),
    COMPARE(41, OFInstructionCompare.class, new OFInstructionCompareInstantiable()),
    ...
    static class OFInstructionGetMetadataInstantiable implements Instantiable<OFInstruction> {
        @Override
        public OFInstruction instantiate() {
            return new OFInstructionGetMetadate();
        } }
    static class OFInstructionBranchInstantiable implements Instantiable<OFInstruction> {
        @Override
        public OFInstruction instantiate() {
            return new OFInstructionBranch();
        } }
    static class OFInstructionJumpInstantiable implements Instantiable<OFInstruction> {
        @Override
        public OFInstruction instantiate() {
            return new OFInstructionRelativeJump();
        } }
    static class OFInstructionConditionalRelativeJumpInstantiable implements Instantiable<OFInstruction> {
        @Override
        public OFInstruction instantiate() {
            return new OFInstructionConditionalRelativeJump();
        } }
    static class OFInstructionCompareInstantiable implements Instantiable<OFInstruction> {
        @Override
        public OFInstruction instantiate() {
            return new OFInstructionCompare();
        } }
